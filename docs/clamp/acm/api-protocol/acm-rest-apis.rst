...
.. csv-table::
   ...
   `ACM-R Commissioning Swagger <./swagger.html#tag/Automation-Composition-Definition>`_
...
.. csv-table::
   ...
   `ACM-R Instantiation Swagger <./swagger.html#tag/Automation-Composition-Instance>`_
...
.. csv-table::
   ...
   `ACM-R Monitoring Swagger <./swagger.html#tag/Participant-Monitoring>`_
