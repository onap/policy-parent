...
.. csv-table::
   ...
   `ACM-R Commissioning Swagger <./swagger/>`_
...
.. csv-table::
   ...
   `ACM-R Instantiation Swagger <./swagger#tag/Automation-Composition-Instance>`_
...
.. csv-table::
   ...
   `ACM-R Monitoring Swagger <./swagger#tag/Participant-Monitoring>`_
