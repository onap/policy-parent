...
#. It checks if a Policy Type with that Policy Type ID has been specified in the properties field in
...
#. It checks if a Policy with that Policy ID has been specified in the properties field in the
