...
Commissioning the AC definition:
  Commissioning refers to storing the composition definition on the ACM database. Invoke the POST api `http://policy_runtime_ip:port/onap/policy/clamp/acm/v2/compositions`
  on the runtime-acm with the created tosca template as the request payload. This returns a 202 response on the successful creation of
...
Prime AC definitions:
  ...
  Invoke the PUT request `http://policy_runtime_ip:port/onap/policy/clamp/acm/v2/compositions/${compositionId}` with the following data on the request body.
...
Deploy AC instance:
  ...
  Invoke the PUT request `http://policy_runtime_ip:port/onap/policy/clamp/acm/v2/compositions/${compositionId}/instances/${instanceId}`
  ...
  The deployment status can be fetched through the following endpoint to get the current status.
  Invoke a GET request `http://policy_runtime_ip:port/onap/policy/clamp/acm/v2/compositions/${compositionId}/instances/${instanceId}`
...
Uninstantiate AC instance:
  ...
  Invoke the DELETE request `http://policy_runtime_ip:port/onap/policy/clamp/acm/v2/compositions/${compositionId}/instances/${instanceId}`
...
Deprime Ac defintions:
  ...
  Invoke the PUT request `http://policy_runtime_ip:port/onap/policy/clamp/acm/v2/compositions/${compositionId}`
...
Delete AC defintion:
  ...
  Invoke the DELETE request `http://policy_runtime_ip:port/onap/policy/clamp/acm/v2/compositions/${compositionId}`
