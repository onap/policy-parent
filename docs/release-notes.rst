...
* Improvements to CLAMP Automation Composition Management (ACM)
  ...
  rApps made up of an arbitrary number of microservices and rules/learming models/schems in the form of metadata. In the London release,
  ...
  `ITU Recommendation X.731 <https://www.itu.int/rec/T-REC-X.731-199201-I/en>`_ is now supported for state reporitng from rApp microservices.
...
* Metadata driven API Generation
  ...
  Up until now, the Policy Framework components used handwritten code to implment their REST interfaces and the Swagger 2 API documentation was generated from
...
* Improved Testing
  ...
  Testing is much improved in the London release.
    - S3P tests ahve been automated and run as CSIT tests
...
.. list-table::
   ...
   * - io.grpc:grpc-core:1.25.0
     ...
     - | policy/models (T)
       ...
       | policy/drools-applications (T)
     - Transitive dependency pulled in by CDS
   * - org.apache.maven:maven-model:3.8.6 (3.9.0)
     - 6
     - | policy/drools-pdp (T)
