...
Please see the
`Installing or Upgrading Policy <https://onap.readthedocs.io/en/guilin/submodules/policy/parent.git/docs/installation/oom.html#installing-or-upgrading-policy>`__ section for appropriate procedures.
