...
see the `XACML Optimization application implementation <xacml-optimization-label>`_.

2.4.1 Optimization Service Policy Type onap.policies.optimization.Service
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Several additional policy types inherit from the Service Optimization Policy Type. For more information, `XACML Optimization
application implementation <xacml-optimization-label>`_.

2.4.2 Optimization Resource Policy Type onap.policies.optimization.Resource
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Several additional policy types inherit from the Resource Optimization Policy Type. For more information, `XACML Optimization
application implementation <xacml-optimization-label>`_.
