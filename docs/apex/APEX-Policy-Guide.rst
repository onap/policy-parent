...
The Nashorn Javascrpt engine was removed from Java in the Java 11 release. Java 11 was introduced into
the Policy Framework in the Frankfurt release, so from Frankfurt on, APEX sJavascript scripts use the Rhino
