...
==================
               ...
               .. container:: paragraph
                  ...
                  And the keys should exactly match with the tags defined in url.
                  The scope of properties object is per HTTP call.
               ...
               .. container:: colist arabic
                  ...
                  | **1** | set REST client as carrier technology            |
                  +-------+--------------------------------------------------+
                  | **2** | the statical URL of the HTTP server for events   |
                  +-------+--------------------------------------------------+
