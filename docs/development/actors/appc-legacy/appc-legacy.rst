...
#############################
ONAP Policy Framework enables APPC Legacy as as one of the supported actors.
...
Summing it up: CBA execute payload generation as done by Policy
*********************************************************************
...
Operational Policy configuration to use CDS as an actor
==========================================================
...
Control Loop Operational Policy YAML to use the CDS actor
-------------------------------------------------------------
...
API to configure the Control Loop Operational policy
--------------------------------------------------------
