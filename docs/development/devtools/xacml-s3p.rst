...
- Decisions, 10 simultaneous threads
  - Monitoring Decision
...
The test was run for 20 minutes at a time, for different numbers of users, with the
following results:
...
The through-put reported by jmeter was 4849 requests/second.  In addition, the memory
usage observed via "top" indicated that the virtual memory and resident set sizes
remained virtually unchanged through-out the test.
...
.. code-block:: bash
    ...
    12349 CPU minutes * 60000ms/minute / 1193277832 requests = 0.62ms/request
