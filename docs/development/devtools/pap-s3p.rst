...
- **Create Policy defaultDomain** - creates an operational policy using the policy type create in above step using policy/api component
- **Create Policy sampleDomain** - creates an operational policy using the policy type create in above step using policy/api component
...
- **Create/Update PDP Group** - create a new PDPGroup named sampleGroup.
- **OS Process Sampler** - OS Process Sampler to start a new Pdp Instance
- **Check PdpGroup Query** - makes a PdpGroup query request and verify that 2 PdpGroup are in ACTIVE state and defaultGroup has a policy deployed on it.
- **Deployment Update sampleDomain** - deploys the policy sampleDomain in sampleGroup PdpGroup using pap api
- **Check PdpGroup Query** - makes a PdpGroup query request and verify that defaultGroup has a policy defaultDomain deployed on it and sampleGroup has policy sampleDomain deployed on it.
...
- **Undeploy Default Policy** - undeploy the policy defaultDomain from PdpGroup
