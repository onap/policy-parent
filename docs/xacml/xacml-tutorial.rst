...
.. image:: images/eclipse-create-maven.png

.. image:: images/eclipse-maven-project.png

Be sure to import the policy/xacml-pdp project into Eclipse.

.. image:: images/eclipse-import.png
...
For this part, you would probably want to use JUnit tests to help ensure the code is implemented
correctly and has the necessary code coverage. You can reference the existing XACML PDP applications
for instructions on how to build JUnit test.
