...
If you are using Eclipse, the credentials can be found in the file **install-drools/src/files/base.conf** within the "drools-pdp" repository user "TELEMETRY_USER" and "TELEMETRY_PASSWORD".
...
// TODO add requests when topic is working
